...
# breast_cancer_prediction documentation build
...
from breast_cancer_prediction import __version__ as release

# -- Project information -----------------------------------------------------

project = "breast_cancer_prediction"
author = "Kedro"
...
htmlhelp_basename = "breast_cancer_predictiondoc"
...
latex_documents = [
    (
        master_doc,
        "breast_cancer_prediction.tex",
        "breast_cancer_prediction Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "breast_cancer_prediction",
        "Project breast_cancer_prediction codebase.",
        "Data-Science",
    )
]
